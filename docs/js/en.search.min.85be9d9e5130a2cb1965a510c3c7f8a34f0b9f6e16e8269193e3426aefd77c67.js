...
input.addEventListener('focus',init);input.addEventListener('keyup',search);function init(){input.removeEventListener('focus',init);loadScript('/documentation_cytech_google_cloud_computing/js/groupBy-62b30ac391.min.js');loadScript('/documentation_cytech_google_cloud_computing/js/flexsearch-ad47a5e1ee.min.js',function(){const indexCfg={};const dataUrl="/documentation_cytech_google_cloud_computing/en.search-data.min.json"
